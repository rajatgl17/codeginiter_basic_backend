...
CREATE TABLE `mst_user_type` (
  `pk_user_type_id` int(11) NOT NULL AUTO_INCREMENT,
  `alias` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`pk_user_type_id`)
...
INSERT INTO `mst_user_type` VALUES (1,'Superadmin'),(2,'Admin');
...
-- Dump completed on 2015-07-20 15:50:41
